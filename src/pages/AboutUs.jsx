        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div>
            <p className="text-lg mb-6">
              Nisarg Nursery is based in Kanheri Sarap and is regarded as one of the Best Nurseries . Founded in 2022, the founders have more than two decades of experience in satisfying retail and wholesale customers, creating an unending list of happy clients.
            ...
            <p className="text-lg mb-6">
              We at Nisarg Nursery help our clients to celebrate gardening and nature in its true colors. With 700 amazing live plants, it is truly a plant lover's paradise. Nisarg Nursery has earned a reputation as a leading firm in the field of plant nurseries and interior and exterior landscaping.
            </p>
            <p className="text-lg">
